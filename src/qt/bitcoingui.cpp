    ...
    rpcConsole(0)
{
    ...
    // Windows OS Styling
    qApp->setStyleSheet("QMainWindow { background-image: url(:/images/GryfenBG);font-family:'Open Sans,sans-serif'; } #frame { } QToolBar QLabel { padding-top:5px;padding-bottom:10px;margin:0px; } #spacer { background: qlineargradient(spread:pad, x1:0, y1:0, x2:0.994318, y2:0.074, stop:0 rgba(244, 48, 48, 255), stop:1 rgba(244, 48, 48, 255));border:none; } #toolbar2 { border:none;width:10px; background-color: qlineargradient(spread:pad, x1:0.972, y1:0.54, x2:0.0227727, y2:0.534, stop:0.0227273 rgba(244, 48, 48, 255), stop:1 rgba(244, 48, 48, 255)); } #toolbar { border:none;height:100%;padding-top:20px; background:transparent; text-align: left; color: black;min-width:200px;max-width:100px;} QToolBar QToolButton:hover {background-color: qlineargradient(spread:pad, x1:0, y1:0.454545, x2:1, y2:0.398, stop:0 rgba(244, 48, 48, 255), stop:1 rgba(244, 48, 48, 255));} QToolBar QToolButton { font-family:Century Gothic;padding-left:20px;padding-right:200px;padding-top:10px;padding-bottom:10px; width:100%; color: white; text-align: left; background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:0.994318, y2:0.074, stop:0 rgba(244, 48, 48, 255), stop:1 rgba(244, 48, 48, 255)); } #labelMiningIcon { padding-left:5px;font-family:Century Gothic;width:100%;font-size:10px;text-align:center;color:white; } QMenu { background: qlineargradient(spread:pad, x1:0.517, y1:0, x2:0.523, y2:0.982955, stop:0 rgba(244, 48, 48, 255), stop:1 rgba(244, 48, 48, 255)); color:white; padding-bottom:10px; } QMenu::item { color:white; background-color: transparent; } QMenu::item:selected { background-color: qlineargradient(spread:pad, x1:0.522364, y1:0.507, x2:0.506, y2:0.897, stop:0 rgba(244, 48, 48, 255), stop:1 rgba(244, 48, 48, 255)); } QMenuBar { background: qlineargradient(spread:pad, x1:0.517, y1:0, x2:0.523, y2:0.982955, stop:0 rgba(244, 48, 48, 255), stop:1 rgba(244, 48, 48, 255)); color:white; } QMenuBar::item { font-size:12px;padding-bottom:12px;padding-top:12px;padding-left:15px;padding-right:15px;color:white; background-color: transparent; } QMenuBar::item:selected { background-color: qlineargradient(spread:pad, x1:0.522364, y1:0.507, x2:0.506, y2:0.897, stop:0 rgba(244, 48, 48, 255), stop:1 rgba(244, 48, 48, 255)); }");
...
//    tabGroup->addAction(poolAction);
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About GryfenCoin"), this);
    aboutAction->setToolTip(tr("Show information about GryfenCoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for GryfenCoin"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to GryfenCoin network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid GryfenCoin address or malformed URI parameters."));
    }
