...
// gryfencrypto: removed limited number of PoW blocks
//static const int LAST_POW_BLOCK = 43200; // at 60 second blocks + Pos block will be about 18 days from launch
...
static const uint256 hashGenesisBlock("000004f951de8ac58ee33b4ce65965734f9191d35adfa7ea8c5c27f60f4fc15f");
static const uint256 hashGenesisBlockTestNet("0000538a81d4b02c0a67d83a5bd6577c0e8fe5f468ae29c78a958aa29e7959c9");
...
public:
    ...
    {
        // gryfencoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // gryfencoin: get transaction coin age
...
public:
    ...
    // gryfencoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // gryfencoin: two types of block: proof-of-work or proof-of-stake
    ...
    // gryfencoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // gryfencoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // gryfencoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // gryfencoin: block index flags
    enum  
    {
